...
/** `.introCard` (portada de marca) y `.finalAlternateCard` (Final "con
 *  fallos", petición de usuario) son tarjetas con su propio layout,
 *  distintas de `.card` (el resto de vistas) — ver `buildIntroCard`/
